...
STAGE_FIELDS: Dict[str, List[dict]] = {
    "l1": [
        ...
        {"key": "research_query", "label": "Research Query", "type": "text", "table": "company_enrichment_l1"},
        {"key": "raw_response", "label": "Raw Response", "type": "json", "table": "company_enrichment_l1"},
        {"key": "confidence", "label": "Confidence", "type": "number", "table": "company_enrichment_l1"},
        {"key": "quality_score", "label": "Quality Score", "type": "number", "table": "company_enrichment_l1"},
    ...
    "l2": [
        ...
        {"key": "competitors", "label": "Competitors", "type": "text", "table": "company_enrichment_profile"},
        ...
        {"key": "quick_wins", "label": "Quick Wins", "type": "json", "table": "company_enrichment_opportunity"},
        {"key": "industry_pain_points", "label": "Industry Pains", "type": "text", "table": "company_enrichment_opportunity"},
        {"key": "cross_functional_pain", "label": "Cross-Functional Pain", "type": "text", "table": "company_enrichment_opportunity"},
        {"key": "adoption_barriers", "label": "Adoption Barriers", "type": "text", "table": "company_enrichment_opportunity"},
    ],
    "registry": [
    ...
    "signals": [
        ...
        {"key": "growth_indicators", "label": "Growth Indicators", "type": "text", "table": "company_enrichment_signals"},
        {"key": "job_posting_count", "label": "Job Posting Count", "type": "number", "table": "company_enrichment_signals"},
        {"key": "hiring_departments", "label": "Hiring Departments", "type": "json", "table": "company_enrichment_signals"},
    ],
    "news": [
    ...
    "person": [
        ...
        {"key": "ai_champion", "label": "AI Champion", "type": "boolean", "table": "contact_enrichment"},
        {"key": "ai_champion_score", "label": "Champion Score", "type": "number", "table": "contact_enrichment"},
        {"key": "authority_score", "label": "Authority Score", "type": "number", "table": "contact_enrichment"},
    ...
    "social": [
        ...
        {"key": "twitter_handle", "label": "Twitter/X", "type": "text", "table": "contact_enrichment"},
        {"key": "speaking_engagements", "label": "Speaking Events", "type": "text", "table": "contact_enrichment"},
        {"key": "publications", "label": "Publications", "type": "text", "table": "contact_enrichment"},
        {"key": "github_username", "label": "GitHub", "type": "text", "table": "contact_enrichment"},
    ],
    "career": [
        {"key": "career_trajectory", "label": "Career Trajectory", "type": "text", "table": "contact_enrichment"},
        {"key": "previous_companies", "label": "Previous Companies", "type": "json", "table": "contact_enrichment"},
        {"key": "industry_experience", "label": "Industry Experience", "type": "json", "table": "contact_enrichment"},
        {"key": "total_experience_years", "label": "Experience Years", "type": "number", "table": "contact_enrichment"},
    ],
    "contact_details": [
        {"key": "email_address", "label": "Email", "type": "text", "table": "contacts"},
        {"key": "phone_number", "label": "Phone", "type": "text", "table": "contacts"},
