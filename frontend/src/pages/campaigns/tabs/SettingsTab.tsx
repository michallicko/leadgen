export function SettingsTab() {
  return (
    <div className="flex flex-col items-center justify-center py-16 text-center">
      ...
      <p className="text-sm font-medium text-text-muted">Campaign Settings</p>
      <p className="text-xs text-text-dim mt-1">Coming soon — configure rules, limits, and scheduling</p>
    </div>
  )
}
