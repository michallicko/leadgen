...
const ENRICHMENT_COLORS: Record<string, string> = {
  'enriched': 'bg-success/15 text-success border-success/30',
  'processed': 'bg-[#00B8CF]/15 text-[#00B8CF] border-[#00B8CF]/30',
  'partial': 'bg-warning/15 text-warning border-warning/30',
  'none': 'bg-[#8B92A0]/10 text-text-dim border-[#8B92A0]/20',
}
...
interface BadgeProps {
  variant: 'status' | 'tier' | 'icp' | 'msgStatus' | 'enrichment'
